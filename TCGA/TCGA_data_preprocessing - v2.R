...
############### GBM dataset
##########
gbm_data_all <- readRDS("data/raw/gbm_gene_raw.rds")
...
############### BRCA dataset
##########
brca_data_all <- readRDS("data/raw/brca_gene_raw.rds")
...
rm(brca_geneExp, brca_geneInfo)
gc()
brca_data_clinic <- readRDS("data/raw/brca_clinical.rds")
